...
public class Seesaw extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        outerAtom4.translateYProperty().set(-CYLHEIGHT);
        ...
        Cylinder bond4 = createConnection(new Point3D(0, 0, 0), new Point3D(0, -CYLHEIGHT, 0));
        bond4.setMaterial(bondMaterial);

        Group group = new Group(outerAtom1, centralAtom, outerAtom2, outerAtom3, outerAtom4, bond1, bond2, bond3, bond4);
